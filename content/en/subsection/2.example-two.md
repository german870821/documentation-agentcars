---
title: Example Two
description: Description for Example Two
navigation:
...
Use inline code to display code snippets within text paragraphs. It's ideal for referencing code elements directly in sentences. `inline code`
